...
<head>
    ...
    <link rel="stylesheet" href="../../static/css/pages/appset_landingpage.less"/>
</head>
<!--   左侧菜单和顶导  -->
<?php $this->load->view('pub/pub-new.php'); ?>
<div class="wrapper">
    <div id="mainContainer" class="appset-landingpage-container" v-cloak="v-cloak">
                ...
                <div class="nav">
                    <div class="ks-breadcrumb">
                        <el-breadcrumb separator="/">
                            <el-breadcrumb-item :to="{ path: '/appset/landingpage' }">一级菜单</el-breadcrumb-item>
...
<script>
    require('../../static/js/pages/appset_landingpage.js');
</script>
</body>
</html>